...
namespace Gamekit3D
{
    ...
    public class PlayerController : MonoBehaviour, IMessageReceiver
    {
        ...
        // Fallback spawn point - stored at game start in case no checkpoints are available
        protected Vector3 m_FallbackSpawnPosition;
        protected Quaternion m_FallbackSpawnRotation;
        ...
        void Awake()
        {
            ...
            // Store the initial spawn position and rotation as a fallback
            // This is used if no checkpoint is set when respawning
            m_FallbackSpawnPosition = transform.position;
            m_FallbackSpawnRotation = transform.rotation;
        }
        ...
        protected IEnumerator RespawnRoutine()
        {
            ...
            // If there is a checkpoint, move Ellen to it. Otherwise use the fallback spawn position.
            ...
            {
                // No checkpoint found - use the fallback spawn position stored at game start
                transform.position = m_FallbackSpawnPosition;
                transform.rotation = m_FallbackSpawnRotation;
            }
